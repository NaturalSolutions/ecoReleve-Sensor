...
BEGIN
	...
	INSERT INTO @data_to_insert (data_id,platform_,date_,lat,lon,speed,course,ele,FK_ind,creator,name)
		SELECT 
		data_PK_ID
		,ptt
		,date_
	...
	from @data_to_insert d join TStations s on d.lat=s.LAT and d.lon = s.LON and d.date_ = s.DATE and d.name=s.Name
